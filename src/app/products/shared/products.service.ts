...
import { MyProduct } from './my-product.model';
...
export class ProductsService {
  ...
  getProducts(): Product[] {
    return [
      new MyProduct('Xiaomi Redmi 5 Plus 3GB/32GB (черный)',
      ...
      new MyProduct('Холодильник Samsung RS55K50A02C',
      ...
      new MyProduct('Lenovo Legion Y520-15 [80WK002MRK]',
